...
const HomeSlider = () => {
  ...
  <div className="card-body">
    <h2 className="card-title">KarKow</h2>
    <p>If a dog chews shoes whose shoes does he choose?</p>
    <div className="card-actions justify-end">
    <NavLink to="/karkow" as={Link}> <button className="btn btn-primary">Travel Karkow</button></NavLink>
    </div>
  </div>
</div>
          </div>
  ...
  <div className="card-body">
    <h2 className="card-title">Piran</h2>
    <p>If a dog chews shoes whose shoes does he choose?</p>
    <div className="card-actions justify-end">
    <NavLink to="/piran" as={Link}> <button className="btn btn-primary">Travel Piran</button></NavLink>
    </div>
  </div>
</div>
          </div>
